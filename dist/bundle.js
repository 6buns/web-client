      ...
      function Bun(_a) {
          ...
          _this.getStats = function () {
              return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                  var statsData, _a, _b, _c, id, peer, _d, _e, e_2_1;
                  var e_2, _f;
                  return __generator(this, function (_g) {
                      switch (_g.label) {
                          ...
                          case 1:
                              ...
                              _a = __values(this.peers), _b = _a.next();
                              _g.label = 2;
                          case 2:
                              if (!!_b.done) return [3 /*break*/, 5];
                              _c = __read(_b.value, 2), id = _c[0], peer = _c[1];
                              _d = statsData;
                              _e = id;
              ...
              if (id) {
                  ...
                  try {
                      for (var _b = __values(_this.peers), _c = _b.next(); !_c.done; _c = _b.next()) {
                          var _d = __read(_c.value, 2), id_1 = _d[0], peer = _d[1];
          ...
          _this.replaceMedia = function (media, id) {
              return new Promise(function (resolve, reject) {
                  ...
                  try {
                      if (id) {
                          try {
                              for (var _d = __values(media.getTracks()), _e = _d.next(); !_e.done; _e = _d.next()) {
                                  var track = _e.value;
                                  id
                          ...
                          try {
                              for (var _f = __values(_this.peers), _g = _f.next(); !_g.done; _g = _f.next()) {
                                  var _h = __read(_g.value, 2), id_2 = _h[0], peer = _h[1];
                                  if (peer.getSenders().length > 0) {
                                      try {
                                          for (var _j = (e_6 = void 0, __values(media.getTracks())), _k = _j.next(); !_k.done; _k = _j.next()) {
                                              var track = _k.value;
          ...
          _this.addMediaTrack = function (track, id) {
              ...
              if (id) {
                  ...
                  if (_this.peers.size > 0) {
                      try {
                          for (var _b = __values(_this.peers), _c = _b.next(); !_c.done; _c = _b.next()) {
                              var _d = __read(_c.value, 2), id_3 = _d[0], peer = _d[1];
                              peer.addTrack(track);
                          }
                      }
          ...
          _this.sendData = function (message, id, type) {
              ...
              if (id) {
                  ...
                  try {
                      for (var _b = __values(_this.sendDataChannels), _c = _b.next(); !_c.done; _c = _b.next()) {
                          var _d = __read(_c.value, 2), id_4 = _d[0], sendChannel = _d[1];
          ...
          _this.id = btoa(Math.random().toString())
              ...
              .join("");
          _this.socket = lookup("https://p2p.6buns.com", {
          ...
          _this.socket.on("connection", function (id, users, iceServers) {
              ...
              _this.iceServers = __spreadArray([], __read(iceServers), false);
              if (_this.peers.size > 0) {
